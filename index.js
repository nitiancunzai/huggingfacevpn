...
const UUID = process.env.UUID || '3c2ad9c1-7c72-446f-8682-854c9ee537ec'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'huggingfacevpn';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'HuggingfaceVPN';                    // 节点名称
